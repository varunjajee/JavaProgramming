...
public class Dog extends Animal{
	...
	public String type="julie";

	@Override
	void walk() {
		System.out.println(this.name);	// gets value current/this class property.
		System.out.println(super.name);	// gets value from the super/parent class - NOTE: same goes with method. this.method-name or super.method
