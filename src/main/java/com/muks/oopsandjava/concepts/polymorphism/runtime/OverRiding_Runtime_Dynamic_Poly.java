package com.muks.oopsandjava.concepts.polymorphism.runtime;

/**
 * Runtime or method overriding or dynamic polymorphism
 *
...
public class OverRiding_Runtime_Dynamic_Poly {
    ...
    /**
        Polymorphism # 2
        Animal myDog = new Dog();       // up-casting object also known as runtime polymorphism
     */
