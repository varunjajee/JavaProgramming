...
/*  Immutable simply means unmodifiable or unchangeable
    - String is designed to be b_immutable for the sake of efficiency and security.
    - This is also the reason why b_immutable classes are preferred in javageneraleg
